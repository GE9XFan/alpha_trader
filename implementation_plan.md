...
| Signal Generation | `signal_generator.py` | 698 | 98% | Dependency-injected strategies, feature normalization, guardrails, and circuit-breaker backoff in place; VPIN/OBI field mismatch resolved with Redis schema fallbacks—next audit other analytics payloads for naming drift.【F:src/signal_generator.py†L48-L274】【F:src/signal_generator.py†L624-L658】 |
