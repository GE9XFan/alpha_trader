...
- **Rolling analytics fabric** – Portfolio calculators publish VPIN, GEX/DEX, and toxicity metrics alongside Redis-backed z-score statistics so downstream strategies can reason about regime shifts without recomputing history.【F:src/analytics_engine.py†L35-L584】【F:src/gex_dex_calculator.py†L47-L105】【F:src/gex_dex_calculator.py†L370-L594】
...
- **Bracketed execution & lifecycle automation** – Executed fills automatically register stop-loss and profit targets under a shared OCA group while manual or automated exits tear down every bracket leg to prevent orphaned orders.【F:src/execution_manager.py†L828-L972】【F:src/position_manager.py†L741-L773】
